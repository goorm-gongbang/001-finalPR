...
| **DB 인스턴스** | `db.t4g.medium` (PostgreSQL 16) | **`max_connections = 250`** — RDS 공식 `LEAST(DBInstanceClassMemory/9531392, 5000)` 기준, 기본값 ~450에서 앱 풀 합산에 맞춰 제한 |
...
| `postgres_max_connections` | DB 서버 측 최대 연결 수 (250) |

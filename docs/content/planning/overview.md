...
| **클라우드 인프라** | 멀티 환경(Dev/Staging/Prod), 고가용성 배포, 피크 대비 리소스 확장, 서비스메쉬 트래픽 제어, 분산 트레이싱 기반 SRE/관측성 | AWS EKS, Karpenter, KEDA, Istio, Grafana 스택(Prometheus·Loki·Tempo) |
| **보안** | 외부망부터 애플리케이션까지 4계층 심층 방어(CDN, ALB, Istio WAF, mTLS), 앱 보안(JWT 인증, 보안 헤더, 난독화) | Istio, AWS Shield, Lua, JWT |

...
![Attack swarm architecture](/images/ai/attack/swarm.png)

> **시뮬레이션 계층** (오른쪽): 여러 독립 PC가 각자의 스웜을 돌림, PC 간 통신 없음.
> **스웜 계층** (PC 1 내부): 한 PC의 에이전트들 + Event Bus + LLM Coordinator + Strategy Store + Monitor/Audit.
> **에이전트 계층** (파란색): 결정론 FlowState 상태머신, LLM 미사용. LLM은 스웜 레벨 전략 조정에만 관여.

...
k6 Controller는 **부하 테스트의 실행·모니터링·결과 취합을 한 UI로 통합한 자체 구축 컨트롤러**입니다. Go 서버에 HTMX와 JS를 함께 써 구현되었고, 팀원 누구나 브라우저에서 VU 범위·Duration·테스트 대상 API를 선택하고 즉시 부하를 쏠 수 있습니다.

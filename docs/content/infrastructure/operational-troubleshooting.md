...
| 제목 | 분류 | 환경 |
|------|-----|------|
| [ArgoCD·Grafana 접속 복구](./operational-troubleshooting/access-point-recovery) | 접근 경로·복구 | Prod EKS |
| [Policy Reporter UI 복구](./operational-troubleshooting/policy-reporter-ui) | 보안 관측·접근 | Staging EKS |
| [Auth-Guard 500 복구](./operational-troubleshooting/auth-guard-500) | 인증·데이터베이스 | Staging EKS |
